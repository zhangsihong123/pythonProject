...
# 查票
# 常用三字码与站点对应关系
areatocode = {"上海": "SHH", "北京": "BJP", "南京": "NJH", "昆山": "KSH", "杭州": "HZH", "桂林": "GLZ","深圳":"SZQ", "武汉": "WHN", "汉口":"HKN", "长沙":"CSQ","西安北":"XAY"}
# start1 = input("请输入起始站:")
start1="杭州"
...
url = "https://kyfw.12306.cn/otn/leftTicket/queryZ?leftTicketDTO.train_date=" + date + "&leftTicketDTO.from_station=" + start + "&leftTicketDTO.to_station=" + to + "&purpose_codes=" + student

# url2 = "https://kyfw.12306.cn/otn/leftTicket/queryX?leftTicketDTO.train_date=2018-12-24&leftTicketDTO.from_station=SZQ&leftTicketDTO.to_station=WHN&purpose_codes=ADULT"
# url2 = "https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date=2018-12-11&leftTicketDTO.from_station=HZH&leftTicketDTO.to_station=WHN&purpose_codes=ADULT"
...
while True:
    urllib.request.urlretrieve(yzmurl, "E:\\privateFile\\pythonProject\\12306demo\\12306_yzm.png")
...
while True:
    ...
    try:
        ...
        bookurl = "https://kyfw.12306.cn/otn/leftTicket/queryZ?leftTicketDTO.train_date=" + date + "&leftTicketDTO.from_station=" + start + "&leftTicketDTO.to_station=" + to + "&purpose_codes=" + student
